...
(function(factory) {
    ...
    // Set up LatLon appropriately for the environment. Start with AMD.
    if (typeof define === 'function' && define.amd) {
        define(['vector3d', 'dms'], function (Vector3d, Dms) {
            return factory(Vector3d, Dms);
        });
